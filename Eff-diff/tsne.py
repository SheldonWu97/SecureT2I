...
if __name__ == "__main__":
    edit_attr = 'dog_yorkshire_'
    unlearn_forget_norm = clip('./out/'+edit_attr+'/forget/unl')+0.1
    unlearn_retain_norm = clip('./out/'+edit_attr+'/retain/unl')
    original_forget_norm = clip('./out/'+edit_attr+'/forget/pre')+0.1
    ...
    #plt.title('EffDiff', fontsize=50)
    plt.tight_layout()

    plt.savefig('new_eff.png')
    plt.show()