...
def parse_args_and_config():
    ...
    parser.add_argument('--retain_label', type=bool, default=True, help='use retain set images as GT for forget set')
    ...
    parser.add_argument('--exp', type=str, default='./runs/example', help='Path for saving running related data.')
    ...
    # Loss & Optimization
    parser.add_argument('--clip_loss_w', type=float, default=1.0, help='Weights of CLIP loss')
    parser.add_argument('--clr_loss_w', type=int, default=3, help='Weights of CLIP loss')
    parser.add_argument('--l1_loss_w', type=float, default=3.0, help='Weights of L1 loss')
