...
def parse_args_and_config():
    ...
    # Text
    parser.add_argument('--edit_attr', type=str, default='sketch', help='Attribute to edit defiend in ./utils/text_dic.py')
    ...
    parser.add_argument('--vague', type=str, default='motion', help='8x8, 16x16, 32x32, gau, box, motion')

    # Train & Test
    parser.add_argument('--attack', type=bool, default=True, help='Whether to do attacking.')
    parser.add_argument('--retrain', type=bool, default=False, help='Retrain the model from scratch.')
    ...
    parser.add_argument('--model_path', type=str, default='pretrained/celeba_hq.ckpt', help='Test model path') #celeba_hq.ckpt
    ...
    parser.add_argument('--n_iter', type=int, default=15, help='# of iterations of a generative process with `n_train_img` images (5)')
